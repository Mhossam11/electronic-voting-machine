...
? Function Arguments : unsigned char PORTx,unsigned
char PINx,unsigned char direction
? Function Description : Set the direction of the given pin in
the given port (direction 0 = input : 1 = output)
? */
...
portname,unsigned char pinnumber,unsigned
char outputvalue
? Function Description : Set the value of the given
pin in the given port (outputvalue 0 = low : 1 =
high)
? */
void DIO_write(unsigned char portname,unsigned char pinnumber,unsigned char outputvalue);
 ...
 ? Function Description : Returns 1 if the value of the given pin is high and zero if the
 value is low
 ? */
